...
The inaugural ACM conference on Equity and Access in Algorithms, Mechanisms, and Optimization (EAAMO ’21) aims to highlight work where techniques from algorithms, optimization, and mechanism design, along with insights from the social sciences and humanistic studies, can help improve equity and access to opportunity for historically disadvantaged and underserved communities. The conference focuses on bridging research and practice by taking a multi-stakeholder approach. Read more about us <a href="https://eaamo.org/#about">below</a>.
</div>
